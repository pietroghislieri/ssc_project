...
var app = require("../routes/professors");
var url = process.env.HEROKU || "http://localhost:3000/home/professors";
...
describe('Protected API /home/professors', () => {
    ...
    it('GET /home/professors should return 200', async () => {
        //expect.assertions(1)
    ...
    it('PUT /home/professors/:{id} should return 200', async () => {
       // expect.assertions(1)
